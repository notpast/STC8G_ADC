...
// This is the register definition file for STC8G series MCU (from STC)
// It is for the SDCC compiler; it doesn't work with Keil or IAR
// You can find the Keil version on the STC website
